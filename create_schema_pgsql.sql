...
CREATE TABLE IF NOT EXISTS informe_diario (
        ...
        "NR_COTST" INTEGER,
        "ANO_REF" INTEGER GENERATED ALWAYS AS (EXTRACT(YEAR FROM "DT_REF")) STORED NOT NULL,
        "MES_REF" INTEGER GENERATED ALWAYS AS (EXTRACT(MONTH FROM "DT_REF")) STORED NOT NULL,
